...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Jan 2025 pada 04.42
...
--
-- AUTO_INCREMENT untuk tabel `cart item`
--
ALTER TABLE `cart item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `produk`
  MODIFY `id_produk` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- Ketidakleluasaan untuk tabel `cart item`
--
ALTER TABLE `cart item`
  ADD CONSTRAINT `cart item_ibfk_1` FOREIGN KEY (`id_cart`) REFERENCES `cart` (`id`),
  ADD CONSTRAINT `cart item_ibfk_2` FOREIGN KEY (`produk_id`) REFERENCES `produk` (`id_produk`);
