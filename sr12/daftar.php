            ...
            <div class="relative bg-white rounded-lg shadow-lg p-8 w-80">
                ...
                <form method="POST" action="daftar.php">
                    ...
                    <div class="flex items-center justify-between">
                        <button id="btn" class="bg-teal-400 hover:bg-teal-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" name="daftar" value="daftar" type="submit">Daftar</button>
                    </div>
                </form>
